...
set_target_properties(FreeGLUT::freeglut PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/freeglut.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/freeglut.dll"
  )
...
set_target_properties(FreeGLUT::freeglut_static PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/freeglut_static.lib"
  )
